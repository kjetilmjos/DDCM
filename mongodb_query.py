...
# Manual input for query configuration
"""
TAG = "EG_80VT6026B.Y(6)"
reference_date = dateutil.parser.parse("2016-05-23 00:00:00")
Date_for_file = "2016-05-23"
MW_tag="EG_80JT6653.Y(6)"
MW_hysteres = 10
"""
TAG = []
reference_date = []
...
for dattiser in config['dates']:
    ...
    Date_for_file.append(dattiser['date'][0:10])
